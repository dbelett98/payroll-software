// LoginForm.tsx: React component for login form (integrates with backend API, React)
import React from 'react';
import { useForm } from 'react-hook-form';  // form handling lib
...
const LoginForm: React.FC = () => {
  ...
  const onSubmit = async (data: LoginData) => {
    try {
      ...
      localStorage.setItem('token', response.data.token);  // Store JWT locally (free browser storage).
